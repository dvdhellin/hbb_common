...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Asistencia Remota RedSión".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://soporte.redsion.es/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://soporte.redsion.es";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://soporte.redsion.es";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remoto.redsion.es"];
pub const RS_PUB_KEY: &str = "Uf0OiPBLuSDS4cbNVaHCGDun8EH+wmnG0yIF1sM9hQU=";
